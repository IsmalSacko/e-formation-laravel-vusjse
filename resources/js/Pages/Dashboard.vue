            ...
            <div class="w-full">
                <form @submit.prevent="submit" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="description" type="text" v-model="form.description">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="" v-for="(episode, index) in form.episodes" v-bind:key="index">
                    ...
                    <button class="bg-red-600 rounded py-2 px-3 text-white block mb-2" v-if="form.episodes.length > 1"
                        @click.prevent="remove">🗑️
                    </button>
