    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <DialogModal :show="confirmingUserDeletion" @close="closeModal">
                ...
                <template #content>
                    Êtes-vous sûr de vouloir supprimer votre compte ? Une fois votre compte supprimé, toutes ses
                    ressources et
                    les données seront définitivement supprimées. Veuillez entrer votre mot de passe pour confirmer que
                    vous souhaitez
